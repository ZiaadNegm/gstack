...
- **Plan Review / Plan summary**: From Step 0 scope challenge and the agreed approach.
- **Alternatives Considered**: From Step 0 scope challenge and architecture review discussions. Include EVERY option that was discussed with the user. Each must have Approach, Pros, Cons, and Con mitigation.
...
- **Risks**: From the failure modes registry and security review. Each with likelihood, blast radius, mitigation.
...
**If the review was SMALL CHANGE mode:** Still write the file. Minimum: one Journey entry (Initial Intent or Plan Review) + Problem Statement + Chosen Solution.
